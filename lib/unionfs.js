...
this.errors.push('#' + util.inspect(this));
  };
        ...
        lib.ensure_mounted(this.path_app, this.tmp_base_app_app, '-o ro --bind', function(respB) {
          if (respB === true) {
            lib.ensure_mounted(this.path_rw, this.tmp_base_rw, '-o rw --bind', function(respC) {
              if (respC === true) {
this.errors.push('#' + util.inspect(unionfs_opts));
this.errors.push('#' + 'sudo unionfs -o ' + unionfs_opts + ' /rw=RW:/app=RO:/os=RO ' + this.target_path);
