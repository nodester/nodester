(function () {
  ...
  unionfs.prototype.start = function () {
    ...
    tmpa = [
      'mount -o ro --bind ' + this.path_base + ' ' + this.tmp_base_os,
      'mount -o ro --bind ' + this.path_app + ' ' + this.tmp_base_app_app,
      'mount -o rw --bind ' + this.path_rw + ' ' + this.tmp_base_rw,
