(function() {
  ...
  chroot.prototype._setup = function(target_path) {
    ...
    this.errors.push('#target: ' +this.target_path);
    this.errors.push('#proc: ' + this.proc_path);
    this.errors.push('#dev: ' + this.dev_path);
  };
  chroot.prototype.start = function(cb) {
    this.errors.push("#Chroot start");
