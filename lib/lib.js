...
var www_domain = "www." + config.opt.top_level_domain;
var top_level_domain = config.opt.top_level_domain;
var api_domain = config.opt.api_domain;
var default_routes = {
  router: {}
};
default_routes.router["127.0.0.1"] = "127.0.0.1:4001";
default_routes.router[www_domain] = "127.0.0.1:4001";
default_routes.router[top_level_domain] = "127.0.0.1:4001";
default_routes.router[api_domain] = "127.0.0.1:4001";
  ...
  apps.view('nodeapps/all', function(err, resp) {
    if (err) {
      ...
      resp.forEach(function(row) {
        proxy_map.router[row._id + "." + config.opt.top_level_domain] = "127.0.0.1:" + row.port;
      });
